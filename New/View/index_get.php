...
<body>
    ...
    <div class="container" style="display: flex; flex-direction: column; ">
        ...
        <div class="row" style="margin-bottom: 100px; text-align: center; border-radius: 8px;">
            <img src="https://www.mcri.edu.au/images/2022/12/MCRI_news_banner_cell_lifecycle_1160x446.jpg" alt="banner " style="width: 1443px; height:436px;">
            <div class="container-i" style="background-color: white; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 800px; height: 300px; opacity: 70%; margin-top: 50px;">
                <h1>Journey Hub</h1>
                <p>
